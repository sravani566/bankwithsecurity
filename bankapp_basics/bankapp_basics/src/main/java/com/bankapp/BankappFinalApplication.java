...
public class BankappFinalApplication  implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		/*
		 * Customer cust= new Customer("Pooja", "pooja123", "admin", "gdv", "gudivada",
		 * "5678129", "p@s.com", LocalDate.of(1980, Month.NOVEMBER, 11)); Customer
		 * cust1= new Customer("Sravani", "sravani123", "mgr", "mdpk", "Tanuku",
		 * "985678129", "s@s.com", LocalDate.of(1982, Month.MAY, 21));
		 * 
		 * customerService.addCustomer(cust); customerService.addCustomer(cust1);
		 * 
		 * Account account1 = new Account("Pooja", 1000.00 , "saving", "near ramalayam",
		 * "Gudivada", "4522896463", "pooja@gm.com", LocalDate.of(1980,Month.NOVEMBER,
		 * 11));
		 * 
		 * Account account2 = new Account("Sravani", 1000.00 , "saving", "gandhi nagar",
		 * "Tanuku", "4522896463", "sravani@gm.com", LocalDate.of(1982,Month.JANUARY,
		 * 21));
		 * 
...
//		
		/*
		 * AddressChangeRequest addressChangeRequest = new AddressChangeRequest("kphb",
		 * "hyderabad", "55654856", "k@s.com");
		 * 
